...
```{r fig.cap="plot_a",echo=TRUE,fig.keep="all", fig.show="asis"}
...
```{r fig.cap="plot_b", echo=TRUE,fig.keep="all", fig.show="asis"}
...
```{r fig.cap="plot_c", echo=TRUE,fig.keep="all", fig.show="asis"}
...
```{r fig.cap="plot_d", echo=TRUE,fig.keep="all", fig.show="asis"}
par(mfrow=c(1,2))
hist(newActivity$steps, breaks=8,main = "Total number of steps per day", xlab = "Steps", col = "blue")
...
```{r fig.cap="plot_e", echo=TRUE,fig.keep="all", fig.show="asis"}
